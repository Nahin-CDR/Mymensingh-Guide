...
public class EducationSection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (wb.canGoBack())
                {
                    ...
                    {
                        live.setVisibility(View.GONE);
                        Toast.makeText(EducationSection.this, "সংযোগ বিচ্ছিন্ন হয়ে গেছে !!", Toast.LENGTH_SHORT).show();
                    }
        ...
        if (savedInstanceState==null)
        {
            wb.post(new Runnable() {
                ...
                public void run() {
                    ...
                    wb.loadUrl("https://shebaabd24.blogspot.com/p/education.html");
        ...
        /* code for calling
         ...
         btnphncall=(ImageButton) findViewById(R.id.btnphncall);
    ...
    /*
     ...
     ActivityCompat.requestPermissions(Education.this, new String[]{Manifest.permission.CALL_PHONE}, 1);
    ...
    private boolean isNetworkConnected(){
        ConnectivityManager cm = (ConnectivityManager) getSystemService(EducationSection.CONNECTIVITY_SERVICE);
        assert cm != null;
