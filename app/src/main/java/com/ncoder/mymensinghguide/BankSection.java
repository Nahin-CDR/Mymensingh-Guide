...
public class BankSection extends AppCompatActivity {
    ImageButton btn;
        ...
        if (savedInstanceState==null)
        {
            wb.post(new Runnable() {
                ...
                public void run() {
                    ...
                    wb.loadUrl("https://shebaabd24.blogspot.com/p/banking.html");
                }
            });
        }
        /* code for full screen **/
        ...
        btnphncall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (telNum.length()==0) {
                    ...
                    Toast.makeText(BankSection.this, "কোনো ফোন নাম্বার প্রবেশ করান নি !!", Toast.LENGTH_SHORT).show();
                } else {
                    if(telNum.length()==11)
                    {
                        ...
                        if(identity.contains( "017" ) || identity.contains( "016" )
                            ...
                            Toast.makeText(BankSection.this, "ভুল নাম্বার প্রবেশ করিয়েছেন !", Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        edtphncall.setError("ভুল নাম্বার প্রবেশ করিয়েছেন !");
                        Toast.makeText(BankSection.this, "ভুল নাম্বার প্রবেশ করিয়েছেন !", Toast.LENGTH_SHORT).show();
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(BankSection.this, new String[]{Manifest.permission.CALL_PHONE}, 1);
    ...
    private boolean isNetworkConnected(){
        ConnectivityManager cm = (ConnectivityManager) getSystemService(BankSection.CONNECTIVITY_SERVICE);
        assert cm != null;
