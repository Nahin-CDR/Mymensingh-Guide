...
public class FastFoodsection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fast_foodsection);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (wb.canGoBack())
                {
                    ...
                    {
                        live.setVisibility(View.GONE);
                        Toast.makeText(FastFoodsection.this, "সংযোগ বিচ্ছিন্ন হয়ে গেছে !!", Toast.LENGTH_SHORT).show();
        ...
        wb.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl){
                wb.loadUrl("file:///android_asset/error_fastFood.html");
                Toast.makeText(FastFoodsection.this, "সংযোগ বিচ্ছিন্ন হয়ে গেছে !!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (savedInstanceState==null)
        {
            wb.post(new Runnable() {
                ...
                public void run() {
                    ...
                    wb.loadUrl("https://shebaabd24.blogspot.com/p/fastfood.html");
                }
            });
        }
        /*code for full screen **/
        ...
        btnphncall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (telNum.length()==0) {
                    ...
                    Toast.makeText(FastFoodsection.this, "কোনো ফোন নাম্বার প্রবেশ করান নি !!", Toast.LENGTH_SHORT).show();
                } else {
                    if(telNum.length()==11)
                    {
                        ...
                        if(identity.contains( "017" ) || identity.contains( "016" )
                            ...
                            Toast.makeText(FastFoodsection.this, "ভুল নাম্বার প্রবেশ করিয়েছেন !", Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        edtphncall.setError("ভুল নাম্বার প্রবেশ করিয়েছেন !");
                        Toast.makeText(FastFoodsection.this, "ভুল নাম্বার প্রবেশ করিয়েছেন !", Toast.LENGTH_SHORT).show();
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(FastFoodsection.this, new String[]{Manifest.permission.CALL_PHONE}, 1);
    ...
    private boolean isNetworkConnected(){
        ConnectivityManager cm = (ConnectivityManager) getSystemService(FastFoodsection.CONNECTIVITY_SERVICE);
        assert cm != null;
