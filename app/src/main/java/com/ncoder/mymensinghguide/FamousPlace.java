...
public class FamousPlace extends AppCompatActivity {
    ...
    LinearLayout mainWebViewLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainWebViewLayout = findViewById(R.id.WebViewLayoutID);
        mainWebViewLayout.setVisibility(View.VISIBLE);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                else
                {
                    ...
                    mainWebViewLayout.setVisibility(View.GONE);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (wb.canGoBack())
                {
                    ...
                    {
                        live.setVisibility(View.GONE);
                        Toast.makeText(FamousPlace.this, "সংযোগ বিচ্ছিন্ন হয়ে গেছে !!", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    if(isNetworkConnected())
                    {
        ...
        wb.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl){
                wb.loadUrl("file:///android_asset/error_famous_place.html");
                Toast.makeText(FamousPlace.this, "সংযোগ বিচ্ছিন্ন হয়ে গেছে !!", Toast.LENGTH_SHORT).show();
        ...
        if (savedInstanceState==null)
        {
            wb.post(new Runnable() {
                @Override
                public void run() {
                    wb.loadUrl("https://shebaabd24.blogspot.com/p/famous-place.html");
                }
            });
        }
        /* code for full screen */
    ...
    private boolean isNetworkConnected(){
        ConnectivityManager cm = (ConnectivityManager) getSystemService(FamousPlace.CONNECTIVITY_SERVICE);
        assert cm != null;
